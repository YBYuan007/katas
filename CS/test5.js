...
function solution(queries) {
  ...
  for (let i = 0 ; i < queries.length ; i ++) {
      let keyWord = queries[i][0]; 
      console.log(keyWord);
      
      switch(keyWord) {
          case 'APPEND' : 
          if (!cursor) {
              result = result + queries[i][1];
              resultOrder.push(result);
          } else {
              let newWord =  queries[i][1]; 
              ...
              if (cursor <= 0 ){
                  ...
                  result = result.slice(0, Number(cursor)) + newWord + result.slice(Number(cursor));
                  // console.log(result);
                  resultOrder.push(result);
          ...
          case 'DELETE' : 
              let newStart = Number(cursor) + 1; 
              // console.log("delete", result, cursor, newStart);
              result = result.slice(0,cursor)+result.slice(newStart);
...
// "You'll never find a rainbow if you're looking down", 
// "You'll nevr find a rainbow if you're looking down", 
// "You'll nevAPPENDr find a rainbow if you're looking down", 
// "You'll nevAPPENDr find a rainbow if you're looking downAPPEND again", 
// "You'll nevAPPENDr find a rainbow if you're looking downAPPEND again", 
// "You'll nevAPPENDr find a rainbow if you're looking downAPPEND again", 
// "You'll nevAPPENDr find a rainbow if you're loAPPEND after MOVEoking downAPPEND again", 
// "You'll nevAPPENDr find a rainbow if you're loAPPEND after MOVEoking downAPPEND again", 
// "You'll nevAPPENDr find a rainbow if you're loAPPEND after MOVEoking downAPPEND again", 
// "You'll nevAPPENDr find a rainbow if you're loAPPEND after MOVEoking downAPPEND again", 
// "You'll nevAPPENDr find a rainbow if youre loAPPEND after MOVEoking downAPPEND again"]
// Expected Output:
// ["You'll never find a rainbow if you're looking down", 
// "You'll never find a rainbow if you're looking down", 
// "You'll nevr find a rainbow if you're looking down", 
// "You'll nevAPPENDr find a rainbow if you're looking down", 
// "You'll nevAPPENDAPPEND againr find a rainbow if you're looking down", 
// "You'll nevAPPENDAPPEND againr find a rainbow if you're looking down", 
// "You'll nevAPPENDAPPEND againr find a rainbow if you're looking down", 
// "You'll nevAPPENDAPPEND againr find a rainbow APPEND after MOVEif you're looking down", 
// "You'll nevAPPENDAPPEND againr find a rainbow APPEND after MOVEf you're looking down", 
// "You'll nevAPPENDAPPEND againr find a rainbow APPEND after MOVE you're looking down", 
// "You'll nevAPPENDAPPEND againr find a rainbow APPEND after MOVE you're looking down", 
// "You'll nevAPPENDAPPEND againr find a ranbow APPEND after MOVE you're looking down"]
